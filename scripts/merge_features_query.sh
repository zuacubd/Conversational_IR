...
then
	time bash -c "echo \"output/features/$COLLECTION""_""$TOPICS.query_features_dorian.ftr\"; echo \"output/features/$COLLECTION""_""$TOPICS.query_idf_features.ftr\"; echo \"output/features/$COLLECTION""_""$TOPICS.query_features_py.ftr\"; echo \"output/features_merged/$COLLECTION""_""$TOPICS.query_doc_aggregated.ftr\"; echo \"output/features/$collection_name""_Dirichlet_LM_""$TOPICS.query_NQC_UQC_WIG_QF_QFDOC_QFTERM_QFJSD_QFHYBRID.ftr\"" | "$PYTHON_PROGRAM" ../scripts/merge_features.py -w 1  > "$OUTPUT_MATRIX"
...
then
	...
	time bash -c "echo \"output/features/$COLLECTION""_""$TOPICS.query_features_dorian.ftr\"; echo \"output/features/$COLLECTION""_""$TOPICS.query_features_tanguy.ftr\"; echo \"output/features/$COLLECTION""_""$TOPICS.query_idf_features.ftr\"; echo \"output/features/$COLLECTION""_""$TOPICS.query_features_py.ftr\"; echo \"output/features_merged/$COLLECTION""_""$TOPICS.query_doc_aggregated.ftr\"; echo \"output/features/$collection_name""_""Dirichlet_LM_""$TOPICS.query_NQC_UQC_WIG_QF_QFDOC_QFTERM_QFJSD_QFHYBRID.ftr\"" | "$PYTHON_PROGRAM" ../scripts/merge_features.py -w 1  > "$OUTPUT_MATRIX"
